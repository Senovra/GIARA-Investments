      ...
      >
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-6 md:px-10">
          <Link href="/" className="relative z-50 flex shrink-0 items-center" aria-label="GIARA — Home">
            {/* An inline SVG rather than an image file, so Samsung
                Internet's forced dark mode recolours the wordmark along
                with the nav text instead of leaving it dark on a blackened
                header. This also replaces the old solid/transparent logo
